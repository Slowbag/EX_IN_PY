...
while True:
	...
	os.system("cls")
	doge.doge()
	print(f'Меню\n1.Установка нужных копонентов\n2.Показать таблицу\n3.Показать 1-3 уровень продукций')
	print(f'4.Показать 4 уровень продукций\n5.Остальное\n6.Показать таблице отчета')
	print(f'7.Сохранить отчет и открыть\n8.Выход')
